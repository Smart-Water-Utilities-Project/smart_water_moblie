...
class _TargetCardState extends State<TargetCard> {
  ...
  void initState() {
    ...
    super.initState();
    timelyProvider.addListener(setStateFunc);
  }
  ...
  void dispose() {
    ...
    super.dispose();
    timelyProvider.removeListener(setStateFunc);
  }
  ...
  Widget build(BuildContext context) {
    ...
    print(timelyProvider.level - timelyProvider.offsetHeight);
    ...
    return ListenableBuilder(
        ...
        builder: (context, child) => InfoCard(
            ...
            widget: Stack(alignment: Alignment.centerLeft, children: [
              Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                ListenableBuilder(
                    listenable: timelyProvider,
                    builder: (context, _) => AnimatedFlipCounter(
                        fractionDigits: 1,
              ...
              Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                        width: 100,
                        height: 100,
                        child: WaterBottle(value: (percent < 0) ? 0 : percent))
                  ])
            ])));
  }
}
...
class WaterBottle extends StatefulWidget {
  const WaterBottle({super.key, required this.value});
      ...
      return Container(
          ...
          child: ClipRRect(
              ...
              child: AnimatedContainer(
                  ...
                  child: Text("${(widget.value * 100).toStringAsFixed(1)}%",
